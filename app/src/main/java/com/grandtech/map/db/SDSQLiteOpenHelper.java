...
public abstract class SDSQLiteOpenHelper {
    ...
    private boolean mDefaultCreate=true;//是否使用默认的创建方式
    /**
     ...
     */
    public SDSQLiteOpenHelper(Context context,String path, String name, CursorFactory factory, int version,boolean defaultCreate) {
    ...
    public File getDatabasePath(String name){
        ...
        if(mDefaultCreate){
            return new File(mContext.getDatabasePath(name).getPath()) ;
        }else {
